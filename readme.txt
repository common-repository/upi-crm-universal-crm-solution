== UpiCRM – Lead Management & Affiliates management: Any contact form DB, all leads, Social Networks leads, Google sheets, in one place and more. ==
...
= 2.3.8.8 = 
* Fixed min ver wp on readme file

= 2.3.8.7 =
* Verified comp. WP V6.0

= 2.3.8.6 = 
* hot fix - data integrity + email functionality


= 2.3.8.5 = 
* hot fix - data integrity and presentation bug.

= 2.3.8.4 = 
* General bug fixed SMTP email
