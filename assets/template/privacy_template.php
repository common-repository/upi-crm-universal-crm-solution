...
server.", 'upicrm'); ?>
    ...
    <div class="">
        <label>
            ...
            &nbsp;&nbsp;
            <input name="upicrm_text_on_lead_clear" type="text" value="<?php echo  get_option('upicrm_text_on_lead_clear'); ?>" />
        </label>
    </div>
...
<form method="post" onsubmit="return confirm('<?php _e("I confirm I have backed up all the data and I know the deletion process is irreversible.", 'upicrm'); ?>');">
    ...
    <div class="upicrm_datepicker_desg">
        <input type="text" name="from_date" value="<?php echo esc_attr($_POST['from_date']) ?>" class="datepicker" data-dateformat="yy-mm-dd" autocomplete="off" />
        <i class="fa fa-calendar"></i>
    </div>
    <?php _e("to", 'upicrm'); ?>
    <div class="upicrm_datepicker_desg">
        <input type="text" name="to_date" value="<?php echo esc_attr($_POST['to_date']) ?>" class="datepicker" data-dateformat="yy-mm-dd" autocomplete="off" />
        <i class="fa fa-calendar"></i>
    </div>
