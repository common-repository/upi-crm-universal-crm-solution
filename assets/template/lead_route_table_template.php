                                ...
                                foreach ($UpiCRMLeadsRoute->get() as $obj) {
                                    ?><tr>
                                        ...
                                        <td data-belongs=""><?php
                                            ...
                                            ?></td>
                                        <td data-belongs=""><?php
                                            echo upicrm_clean_data($obj->lead_route_value);
                                            if ($obj->lead_route_and) {
                                                echo "<br />";
                                                echo upicrm_clean_data($obj->lead_route_value2);
                                            }
                                            if ($obj->lead_route_and == 2) {
                                                echo "<br />";
                                                echo upicrm_clean_data($obj->lead_route_value3);
                                            }
                                            ?></td>
                                        <td data-belongs=""><?php
                                        ...
                                        <td data-belongs="">
                                            <?php if ($obj->change_field_id > 0) { ?>
                                                ...
                                                &gt;&gt;
                                                <?php echo upicrm_clean_data($obj->change_field_value); ?>
    <?php } ?>
                                        </td>
                                        ...
                                        <td data-belongs=""><?php echo  $obj->affiliate_id > 0 && @isset($GetUserArr[$obj->affiliate_id]) ? $GetUserArr[$obj->affiliate_id] : ""; ?></td>
