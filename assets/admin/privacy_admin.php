    ...
    class UpiCRMAdminPrivacy{
        ...
        private function save() {
            ...
            if (isset($_POST['upicrm_text_on_lead_clear'])) {
                update_option('upicrm_text_on_lead_clear',sanitize_text_field($_POST['upicrm_text_on_lead_clear']));
            }
        }
        
        private function do_date() {
            $UpiCRMLeads = new UpiCRMLeads();
            $getLeads = $UpiCRMLeads->get(0, 0, 0, 'DESC', "custom", sanitize_text_field($_POST['from_date']), sanitize_text_field($_POST['to_date']));
