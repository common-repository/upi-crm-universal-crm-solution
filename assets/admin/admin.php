...
add_filter( 'script_loader_tag', 'defer_js_async', 10 );
    ...
    class UpiCRMAdmin{
        ...
        public function onWpAdminMenu() {
            wp_register_style( 'upicrm_css_bootstrap', UPICRM_URL.'assets/resources/css/bootstrap.css', FALSE, '0.1' );
            if (is_rtl()) {
                wp_register_style( 'upicrm_css', UPICRM_URL.'assets/resources/css/smartadmin-production-rtl.css', FALSE, '0.1' );
            } else {
                wp_register_style( 'upicrm_css', UPICRM_URL.'assets/resources/css/smartadmin-production.css', FALSE, '0.1' );
            }
            wp_register_style( 'upicrm_css_smart_admin_skins', UPICRM_URL.'assets/resources/css/smartadmin-skins.css', FALSE, '0.1' );
            wp_register_style( 'upicrm_css_font','https://maxcdn.bootstrapcdn.com/font-awesome/4.6.1/css/font-awesome.min.css', FALSE, '0.1' ); 
            wp_register_style( 'upicrm_css_bootstrap_multiselect', UPICRM_URL.'assets/resources/css/bootstrap-multiselect.css', FALSE, '0.1' ); 
            wp_register_style( 'upicrm_main_style', UPICRM_URL.'assets/css/style.css', FALSE, '0.7' ); 
            if (is_rtl()) {
               wp_register_style( 'upicrm_main_style_rtl', UPICRM_URL.'assets/css/rtl.css', FALSE, '0.2' ); 
            ...
            wp_register_script('upicrm_js_sparkline',  UPICRM_URL.'assets/resources/js/plugin/sparkline/jquery.sparkline.min.js', array('jquery'), '1.0');
            wp_register_script('upicrm_js_jarvis',  UPICRM_URL.'assets/resources/js/plugin/smartwidgets/jarvis.widget.min.js', array('jquery'), '1.0');
            wp_register_script('upicrm_js_dataTable',  UPICRM_URL.'assets/resources/js/plugin/datatables/jquery.dataTables.min.js', array('jquery'), '1.0');
            wp_register_script('upicrm_js_colVis',  UPICRM_URL.'assets/resources/js/plugin/datatables/dataTables.colVis.min.js', array('jquery'), '1.0');
            wp_register_script('upicrm_js_tableTools',  UPICRM_URL.'assets/resources/js/plugin/datatables/dataTables.tableTools.min.js', array('jquery'), '1.0');
            wp_register_script('upicrm_js_tablebootstrap',  UPICRM_URL.'assets/resources/js/plugin/datatables/dataTables.bootstrap.min.js', array('jquery'), '1.0');
            wp_register_script('upicrm_js_responsive',  UPICRM_URL.'assets/resources/js/plugin/datatable-responsive/datatables.responsive.min.js', array('jquery'), '1.0');
            wp_register_script('upicrm_js_app',  UPICRM_URL.'assets/resources/js/app.js', array('jquery'), '1.1');
            wp_register_script('upicrm_js_bootstrap',  UPICRM_URL.'assets/resources/js/bootstrap.min.js', array('jquery'), '1.1');
            wp_register_script('upicrm_js_bootstrap_multiselect',  UPICRM_URL.'assets/resources/js/bootstrap-multiselect.js', array('jquery'), '1.1');
            wp_register_script('upicrm_js_main',  UPICRM_URL.'assets/js/main.js', array('jquery'), '1.1');
            wp_register_script('upicrm_js_admin',  UPICRM_URL.'assets/js/admin.js', array('jquery'), '1.1');
            ...
            if ($UpiCRMUsers->get_permission() != 3) {
                if (1 <= $UpiCRMUsers->get_permission()) {
                    add_menu_page('UpiCRM', 'UpiCRM', 'read', 'upicrm_index', array( $this, 'onDisplayDashboard' ), UPICRM_URL . 'assets/resources/images/icon_crm.gif', "27.666");
